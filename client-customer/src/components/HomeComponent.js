...
class Home extends Component {
   ...
   renderCarouselIndicators() {
      return [0, 1, 2].map(index => (
         <li
            ...
            onClick={() => this.handleCarouselIndicatorClick(index)}></li>
      ));
   }
   ...
   renderCarouselItems() {
      const carouselItems = [
         ...
         {
            src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT2hFsGMMxNwM47_zO6Lfz673mxl5kliCPlrA&usqp=CAU",
            alt: "Second slide",
         },
         {
         ...
         <div>
            ...
            <div className="container mt-4">
               ...
               {/* <div className="services mt-4 mb-4">
                  <h2 className="text-center background-h2 mb-4">
                     OUR SERVICES
                  </h2>
               ...
               {/* <div className="customer-reviews ">
                  <h3 className="text-center background-h2">
                     CUSTOMER REVIEWS
                  </h3>
                  <div className="customers row">
                     <div className="customer-item col-12 col-sm-6 col-md-4 text-center">
                        ...
                        <p>
                           Excellent service! The delivery was quick and the
                     ...
                     <div className="customer-item col-12 col-sm-6 col-md-4 text-center">
                        ...
                        <p>
                           Highly recommend this store. The products are
                           top-notch, and the customer support is always
                           helpful.
                        </p>
                     </div>
                     <div className="customer-item col-12 col-sm-6 col-md-4 text-center">
                        ...
                        <p>
                           ...
                           exceptional quality, and the customer support is
                        ...
                        <div className="row mt-3">
                           ...
                           <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                              ...
                              <h6 className="text-uppercase fw-bold mb-4">
                                 <i class="fa-solid fa-building"></i> ELECTRO
                                 MART
                              </h6>
                              <p>
                                 Electro Mart is a premier online shopping
                                 destination, offering a modern and convenient
                                 experience for technology and entertainment
                                 {/* enthusiasts. We take pride in our diverse range
                                 of products from leading global brands,
                                 ensuring top-notch quality and excellent
                                 customer service. Explore the world of
                                 cutting-edge technology and entertainment at
                                 Electro Mart today! */}
                              </p>
                           </div>
                           {/* Grid column */}
                           ...
                           <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                              ...
                              <p>
                                 <i className="fas fa-home me-3"></i> 69/68 Dang
                                 Thuy Tram Street, Ward 13, Binh Thanh District,
